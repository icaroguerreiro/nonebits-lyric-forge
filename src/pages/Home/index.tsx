...
import InputTooltip from "../../components/ui/InputTooltip";
      ...
      <Grid container spacing={2}>
        <Grid size={3}>
          <InputTooltip
            tooltip={
              <p>
                The working title of the song. It helps guide the general theme
                and mood.
              </p>
            }
          >
        ...
        <Grid size={3}>
          <InputTooltip
            tooltip={
              <p>
                The language the lyrics will be written in. Affects tone,
        ...
        <Grid size={2}>
          <InputTooltip
            tooltip={
              <p>
                The speed of the song in beats per minute. Higher values feel
        ...
        <Grid size={4}>
          <InputTooltip
            tooltip={
              <>
                <p>
                  The emotional atmosphere that should remain present throughout
                  the entire song.
                </p>
                <p>You can choose multiple emotions to blend.</p>
              </>
            }
          >
        ...
        <Grid size={6}>
          <InputTooltip
            tooltip={
              <>
                <p>
                  A list of thematic or atmospheric words that help guide the
                  lyrical mood.
                </p>
                <p>These words influence metaphors, imagery, and tone.</p>
              </>
            }
          >
            <FreeSoloChipsAutocomplete
        ...
        <Grid size={6}>
          <InputTooltip
            tooltip={
              <>
                <p>
                  A higher-level description of what the AI should focus on when
                  generating the lyrics.
                </p>
                <p>
                  Use this field to define tone, narrative approach, or
                  structural ideas.
                </p>
              </>
            }
                                ...
                                <Grid size={4}>
                                  <InputTooltip
                                    tooltip={
                                      <>
                                        <p>
                                          Artists whose style should inspire the
                                          writing.
                                        </p>
                                        <p>
                                ...
                                <Grid size={3}>
                                  <InputTooltip
                                    tooltip={
                                      <>
                                        <p>
                                          Defines the intensity of this specific
                                    ...
                                    tooltip={
                                      <>
                                        <p>
                                          ...
                                          the section (e.g., gradual rise, drop,
                                          steady).
                                        </p>
                                      </>
                                    }
                                ...
                                <Grid size={6}>
                                  <InputTooltip
                                    tooltip={
                                      <>
                                        <p>
                                          The emotional state the section should
                                          reach by its end.
                                        </p>
                                        <p>
                                ...
                                <Grid size={6}>
                                  <InputTooltip
                                    tooltip={
                                      <>
                                        <p>
                                          If you already have part of the lyrics
                                          written, insert them here.
                                        </p>
                                        <p>
                                ...
                                <Grid size={4}>
                                  <InputTooltip
                                    tooltip={
                                      <>
                                        <p>
                                          Sentence structures to use inside the
                                          section (declarative, interrogative,
                                          imperative).
                                        </p>
                                      </>
                                    }
                                ...
                                <Grid size={4}>
                                  <InputTooltip
                                    tooltip={
                                      <>
                                        <p>
                                          The rhyme pattern used in the section
                                          (e.g., ABAB, AABB).
                                        </p>
                                      </>
                                    }
                                  ...
                                  <InputTooltip
                                    tooltip={
                                      <>
                                        ...
                                        <p>Affects pacing and rhythmic feel.</p>
                                      </>
                                    }
                                  >
                                    <Autocomplete
                                ...
                                <Grid size={2}>
                                  <InputTooltip
                                    tooltip={
                                      <>
                                        <p>
                                          The number of musical bars the section
                                          should fit into.
                                        </p>
                                      </>
                                    }
                                ...
                                <Grid size={3}>
                                  <InputTooltip
                                    tooltip={
                                      <>
                                        <p>
                                          How many notes per bar/phrase. Higher
                                          density feels more energetic.
                                        </p>
                                      </>
                                    }
                                  >
